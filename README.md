...
[![Release: v1.1.0](https://img.shields.io/badge/Release-v1.1.0-orange.svg)](https://github.com/Coronitaa/BlueStar/releases)
...
| :--- | :--- | :--- |
| **Windows Setup (Recommended)** | `BlueStar-v1.1.0-Setup-win-x64.exe` | Standard Windows installer with start menu shortcuts, desktop icons, and uninstaller. |
| **Portable Edition** | `BlueStar-v1.1.0-Portable-win-x64.zip` | Standalone zero-install archive. Extract anywhere and launch `BlueStar.exe`. |
